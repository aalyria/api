...
public class JwtManager {
  ...
  public static class Builder {
    ...
    public JwtManager build() {
      return new JwtManager(
          lifetime, audience, issuer, subject, targetAudience, privateKeyId, privateKey);
    }
  }
  ...
  private PrivateKey decodePrivateKey() {
    String encodedKeyValue =
        privateKey
            .replace(PRIVATE_KEY_HEADER, /* replacement= */ "")
    ...
    try {
      ...
      if (privateKey.isEmpty()) {
        ...
        PrivateKeyInfo privateKeyInfo =
            new PrivateKeyInfo(algorithmIdentifier, ASN1Sequence.getInstance(encodedKey));
    ...
    return privateKey.orElseThrow(
        () -> new IllegalArgumentException("The private key could not be decoded."));
  }
